  ...
  src="http://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=TeX-AMS-MML_HTMLorMML">
	...
	<ul class="menu">
      ...
      <div id="container">
	   ...
	   <p>
	     Un modèle de régression linéaire est un modèle de régression qui cherche à établir une relation linéaire entre une variable, dite expliquée, et une variable, dites explicative.</p>
	   <h3>Régression linéaire simple :</h3>
	   <p>Parmi les modèles de régression linéaire, le plus simple est l'ajustement <b>affine</b>. Celui-ci consiste à rechercher la droite permettant d'expliquer le comportement d'une variable statistique y comme étant une fonction affine d'une autre variable statistique x.</p>
	   <p>La régression <b>polynomiale</b> est une analyse statistique qui décrit la variation d'une variable aléatoire expliquée à partir d'une fonction polynomiale d'une variable aléatoire explicative. C'est un cas particulier de régression linéaire multiple, où les observations sont construites à partir des puissances d'une seule variable.</p>
	</br>
	$Y=a_{0}+a_{1}\,\psi\big(X\big)$
	avec $ \displaystyle Y=\left(\begin{array}{c} y_{1} \\\vdots \\ y_{n}  \end{array}\right)\,\,$  et  $\,\,\displaystyle  X=\left(\begin{array}{c} x_{1} \\\vdots \\ x_{n}  \end{array}\right)$
	<br/>
	<br/>
	Le modèle s'écrit sous la forme :
$$\left\lbrace \begin{array}{l}  
y_{1}=a_0 +a_{1}\,\psi\big(x_{1}\big) \\
y_{2}=a_0 +a_{1}\,\psi\big(x_{2}\big) \\
\vdots \\
	y_{n}=a_0 +a_{1}\,\psi\big(x_{n}\big)\end{array}\right.$$
	<br/>
	<br/>
	Le modèle  s'écrit sous la forme matricielle : $\displaystyle Y=M\,\theta$
	</br>
	</br>
	L'estimateur de $\theta$ noté $\,\hat{\theta}\,$,  réalise  le  minimum de $\displaystyle D(\theta)=\vert\vert Y-M\,\theta \vert\vert^2$
	</br>
	</br>
	On a :
	</br>
...
&=  ^{t}\!Y\,Y -2\, ^{t}\!Y\,M\,\theta +  ^{t}\!\!\theta\,^{t}\!M\,M\,\theta
	...
	Pour la  droite de régression on a :
 $$\displaystyle  Y=a_{0}+a_{1}\,X$$
