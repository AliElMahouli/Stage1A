  ...
  <head>
	...
	<ul class="menu">
	  ...
	  <a href="../detection_anomalies/detection.php">Détection d'anomalies</a>
          ...
          <div id="container">
	<br/>
	<h3>Regression avec le modèle linéaire :</h3>
	</br>
        <img src="modele.png" alt="Historamme" width="700" height="500" class="center">
	</br>
	<h3>Regression avec le modèle polynomial :</h3>
	</br>
        <img src="modele_polynomial.png" alt="Historamme" width="700" height="500" class="center">
	</br>
	<h3>Regression avec sklearn :</h3>
	</br>
	<img src="modele2.png" alt="Historamme" width="700" height="500" class="center">
      </div>
  </body>
</html>
